...
router.get('/all_breads', async (req: Request, res: Response, next: NextFunction) => {
  let results;
...
router.get('/by_bread', async (req: Request, res: Response, next: NextFunction) => {
  let results;
...
router.get('/by_sub_bread', async (req: Request, res: Response, next: NextFunction) => {
  let results;
